...
&nbsp;
      ...
      body        = typeof (options.data || '') == 'string'
                    ...
                    : ( headers['content-type'] || '' ).startsWith('application/json')
                      ? <span class="branch-0 cbranch-no" title="branch not covered" >JSON.stringify(options.data)</span>
                ...
                : require('http')).request(config, (result) =&gt;
      {
        let data = ''
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if(options.pipe)
        {
<span class="cstat-no" title="statement not covered" >          result.pipe(options.pipe)</span>
        }
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Mar 04 2020 17:22:20 GMT+0100 (Central European Standard Time)
</div>
</div>
